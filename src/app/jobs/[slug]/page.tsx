...
export default async function JobDetailPage({
  ...
  return (
    <div suppressHydrationWarning className="flex min-h-screen flex-col bg-[#030303]">
      ...
      <main suppressHydrationWarning className="mx-auto w-full max-w-7xl flex-1 px-4 py-8 sm:px-8">
        ...
        {/* Hero Banner for Job */}
        <div className="mt-6 rounded-3xl border border-white/10 bg-gradient-to-br from-[#0a0a0a] via-[#070707] to-[#030303] p-6 sm:p-10 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <Link
              ...
              className="bg-btn-gradient inline-flex items-center justify-center gap-2 rounded-xl px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-blue-500/25 transition-all hover:brightness-110 shrink-0"
            >
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[#0a0a0a] to-black p-6 sm:p-8">
              <h2 className="font-heading text-lg font-bold text-white flex items-center gap-2 mb-4">
          ...
          <aside className="space-y-6">
            ...
            <div className="sticky top-24 rounded-2xl border border-white/10 bg-[#0a0a0a] p-6 shadow-xl space-y-6">
              ...
              <div className="space-y-4 border-y border-white/[0.08] py-4 text-xs">
              ...
              <Link
                href={`/jobs/${job.slug}/apply`}
                className="bg-btn-gradient flex w-full items-center justify-center gap-2 rounded-xl py-3 text-xs font-bold text-white shadow-md shadow-blue-500/20 transition-all hover:brightness-110"
              >
                <span>Lamar Posisi Ini</span>
                <ArrowRight className="h-4 w-4" />
              </Link>
